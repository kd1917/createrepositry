                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ytys8p4m' /* Fill out the information below... */,
                                      ),
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'b4id5qqh' /* Emails will be sent to: */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                options: [
                                  FFLocalizations.of(context).getText(
                                    '6bxakxch' /* Doctors Visit */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'hdjzqi73' /* Routine Checkup */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'hze6wx5q' /* Scan/Update */,
                                  )
                                ],
                                onChanged: (val) =>
