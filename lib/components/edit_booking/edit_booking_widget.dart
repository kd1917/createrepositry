                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'saz3p3bp' /* Edit the fields below in order... */,
                                  ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'nrp3fday' /* Emails will be sent to: */,
                            ),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'kcosmjah' /* Type of Appointment */,
                              ),
                              FFLocalizations.of(context).getText(
                                'cztvmb2l' /* Doctors Visit */,
                              ),
                              FFLocalizations.of(context).getText(
                                'z2076pj2' /* Routine Checkup */,
                              ),
                              FFLocalizations.of(context).getText(
                                'a4v2ota8' /* Scan/Update */,
                              )
                            ],
                            onChanged: (val) =>
