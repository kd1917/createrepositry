                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '95dc8qqx' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: [
                        FFLocalizations.of(context).getText(
                          'pkwd7oek' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'klhvxjwa' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          'i07qap7m' /* Scan/Update */,
                        )
                      ],
                      onChanged: (val) =>
