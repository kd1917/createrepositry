                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'ci75fubx' /* Headache, heartburn etc... */,
                          ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'l4r0f32f' /* Convulsive disorder that does ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'omh0wx8c' /* Convulsive disorder that does ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'qh2g03ax' /* Convulsive disorder that does ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall,
                                    ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: AutoSizeText(
                                      FFLocalizations.of(context).getText(
                                        'ebbys3hu' /* Convulsive disorder that does ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall,
                                    ),
