                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        FFLocalizations.of(context).getText(
                          'qj7w550j' /* Upload a photo for us to easil... */,
                        ),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        'h2b3wwst' /* What types of allergies do the... */,
                      ),
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: FFLocalizations.of(context).getText(
                        '37kiajmy' /* Please enter a valid email... */,
                      ),
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
