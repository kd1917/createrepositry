                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'd4eqdo55' /* Your next appointment */,
                            ),
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: AutoSizeText(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '8k76sxy5' /* Schedule an appointment with o... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'asnphbd0' /* Give us a call in order to sch... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: AutoSizeText(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'xhauubu2' /* Send us an email and we will g... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
